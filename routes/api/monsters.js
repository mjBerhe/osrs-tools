	...
	try {
		...
		const monster = new Monster({
			...
			stats: [{
				...
				attStab: mon.attack_stab,
				attSlash: mon.attack_slash,
				attCrush: mon.attack_crush,
				attMagic: mon.attack_magic,
				attRanged: mon.attack_ranged,
				defStab: mon.defence_stab,
				defSlash: mon.defence_slash,
				defCrush: mon.defence_crush,
				defMagic: mon.defence_magic,
				defRanged: mon.defence_ranged,
